...
Foam::scalar Foam::epsilonAtmWallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

void Foam::epsilonAtmWallFunctionFvPatchScalarField::checkType()
{
...
void Foam::epsilonAtmWallFunctionFvPatchScalarField::writeLocalEntries
(
    Ostream& os
) const
{
...
void Foam::epsilonAtmWallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1)
    {
        return;
...
void Foam::epsilonAtmWallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& epsilon =
        static_cast<const volScalarField&>(this->internalField());
...
Foam::epsilonAtmWallFunctionFvPatchScalarField&
Foam::epsilonAtmWallFunctionFvPatchScalarField::epsilonPatch(const label patchi)
{
    const volScalarField& epsilon =
        static_cast<const volScalarField&>(this->internalField());
...
void Foam::epsilonAtmWallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
void Foam::epsilonAtmWallFunctionFvPatchScalarField::calculate
(
    const turbulenceModel& turbulence,
...
)
{
    ...
    forAll(nutw, facei)
    {
        ...
        epsilon[celli] += w*Cmu75*pow(k[celli], 1.5)/(kappa_*(y[facei] + z0_[facei])); //MODIFY HERE
        ...
        G[celli] +=
           ...
           *magGradUw[facei]
           *Cmu25*sqrt(k[celli])
           /(kappa_*(y[facei] + z0_[facei])); //MODIFY HERE
    }
}
...
Foam::scalarField& Foam::epsilonAtmWallFunctionFvPatchScalarField::G(bool init)
{
...
Foam::scalarField& Foam::epsilonAtmWallFunctionFvPatchScalarField::epsilon
(
    bool init
)
{
...
void Foam::epsilonAtmWallFunctionFvPatchScalarField::manipulateMatrix
(
...
void Foam::epsilonAtmWallFunctionFvPatchScalarField::write(Ostream& os) const
{
